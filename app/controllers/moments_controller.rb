class MomentsController < ApplicationController
  ...
  # GET /moments.json
  def index
    @moments = Moment.all.latest_created_at
    @moment = Moment.new
  end
  ...
  def create
    ...
    respond_to do |format|
      if @moment.save
        format.html { redirect_to moments_path, notice: 'Moment was successfully created.' }
  ...
  private
    ...
    def moment_params
      params.require(:moment).permit(:unexpected_happiness, :disappointments, :message, :moment_time, :picture)
    end
end
