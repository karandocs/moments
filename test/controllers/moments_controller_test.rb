...
class MomentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moment" do
    assert_difference('Moment.count') do
      post moments_url, params: { moment: { disappointments: @moment.disappointments, message: @moment.message, unexpected_happiness: @moment.unexpected_happiness } }
    end
  ...
  test "should update moment" do
    patch moment_url(@moment), params: { moment: { disappointments: @moment.disappointments, message: @moment.message, unexpected_happiness: @moment.unexpected_happiness } }
