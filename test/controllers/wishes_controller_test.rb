...
class WishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post wishes_url, params: { wish: { completed: @wish.completed, reason: @wish.reason, should_happen_on: @wish.should_happen_on, wish: @wish.wish } }
    end
  ...
  test "should update wish" do
    patch wish_url(@wish), params: { wish: { completed: @wish.completed, reason: @wish.reason, should_happen_on: @wish.should_happen_on, wish: @wish.wish } }
